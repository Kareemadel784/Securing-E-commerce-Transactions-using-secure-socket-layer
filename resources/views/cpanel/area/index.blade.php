        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">     {{trans('app.area')}}</li>
                </ol>
            </div>
                                ...
                                @for($i=0;$i<count($area);$i++)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('area.edit',$area[$i]->ids)}}" class="btn btn-warning" >
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            {{--@endpermission--}}
                                            {{--@permission('حذف حساب')--}}
                                            <a><form action="{{route('area.destroy',$area[$i]->ids)}}" style="display: inline;" method="POST" accept-charset="utf-8">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
