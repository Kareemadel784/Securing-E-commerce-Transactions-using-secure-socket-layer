        ...
        <section class="content">
            <div class="box box-body">
                ...
                <div class="box box-primary">
                    <form action="{{route('subcategory.update',$area[0]->ids)}}" method="post" role="form" accept-charset="utf-8" enctype="multipart/form-data">
                        {{method_field('PATCH')}}
                        {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="categore_id">
                                    @for($i=0;$i<count($area);$i++)
                                        <option id="cat" name="cat"  <?php if( $area[$i]->categore_id == $subcategory[0]->categore_id) echo  "selected"; ?>
