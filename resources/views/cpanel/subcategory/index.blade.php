        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">     {{trans('app.subcategory')}}</li>
                </ol>
            </div>
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="myTable" class="table display table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$subcategory[$i]->subcategory_name}}</td>
                                    <td>
                                        {{--@permission('تعديل حساب')--}}
                                        <a href="{{route('subcategory.edit',$subcategory[$i]->subcat_id)}}" class="btn btn-warning" >
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        {{--@endpermission--}}
                                        {{--@permission('حذف حساب')--}}
                                        <a><form action="{{route('subcategory.destroy',$subcategory[$i]->subcat_id)}}" style="display: inline;" method="POST" accept-charset="utf-8">
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
