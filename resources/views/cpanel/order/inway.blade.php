        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">كل  الطلبات في الطريق</li>
                </ol>
            </div>
        ...
        @if (\Session::has('finish'))
            <div class="col-xs-12">
                <div class="alert alert-success">
                    ...
                    <strong>Success!</strong>تم تسليم الطلبات للعميل
                </div>
            </div>
        @endif
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="table display table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td id="print1" style="display:none">
                                        <input type="checkbox" style="width: 40px;height: 40px; position: initial;right: -9999px;opacity: 01;" id="edit-node-types-article" form="myform" name="cheackbox1[]"
                                               value="{{$allsendorder[$i]['id']}}">
                                    </td>
                            ...
                            <div class="form-group" style=" margin: 50px;">
                                <form action="{{url('admin/finishorder')}}"  method="POST" id="myform">
                                    {{ csrf_field () }}
                                    <input onclick="return confirm('هل انت متاكد من تسليم الطلبات المحدده  ؟');"
                                           type="submit" style="float: right;" class="btn btn-success pull-left" value="تسليم الطلبات المحدده"/>
                                </form>
