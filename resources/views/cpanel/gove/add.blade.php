        ...
        <section class="content">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{route('gove.store')}}" method="post" role="form" accept-charset="utf-8" enctype="multipart/form-data"  >
                        {{csrf_field()}}
                        <div class="card card-body col-md-6">
                            <div class="form-group">
                                <label for="name">  {{trans('app.gove')}}  <span style="color:red;">*</span>:</label>
                                <input name="gove" type="text" class="form-control" id="name"  required />
                            </div>
                            <div class="form-group">
                                <label for="name">  {{trans('app.goveenglish')}}  <span style="color:red;">*</span>:</label>
                                <input name="goveenglish" type="text" class="form-control" id="name"  required />
                            </div>
