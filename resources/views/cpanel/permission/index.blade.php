    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">كل بيانات الصلاحيات </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('admin')}}"> الرئيسيه</a></li>
                    <li class="breadcrumb-item active">كل الصلاحيات </li>
                </ol>
            </div>
                                ...
                                @foreach($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a><form action="{{route('permission.destroy',$permission->id)}}" style="display: inline;" method="POST" accept-charset="utf-8">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
