        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{trans('app.cat')}}</li>
                </ol>
            </div>
                            ...
                            <table id="myTable" class="table display table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('category.edit',$category[$i]->ids)}}" class="btn btn-warning" >
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        {{--@endpermission--}}
                                        {{--@permission('حذف حساب')--}}
                                        <a><form action="{{route('category.destroy',$category[$i]->ids)}}" style="display: inline;" method="POST" accept-charset="utf-8">
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
